  ...
  <!DOCTYPE html><html lang="en-US"><head resURL="/static/0ea33504" data-rooturl="" data-resurl="/static/0ea33504"><title>Sign in [Jenkins]</title><meta name="ROBOTS" content="NOFOLLOW" /><link rel="stylesheet" href="/static/0ea33504/css/simple-page.css" type="text/css" /><link rel="stylesheet" href="/static/0ea33504/css/simple-page.theme.css" type="text/css" /><link rel="stylesheet" href="/static/0ea33504/css/simple-page-forms.css" type="text/css" /></head><body><div class="simple-page" role="main"><div class="modal login"><div id="loginIntroDefault"><div class="logo"></div><h1>Hello Anooruddh, Welcome to Jenkins!</h1></div><form method="post" name="login" action="j_acegi_security_check"><div class="formRow"><input autocorrect="off" name="j_username" id="j_username" placeholder="Username" type="text" class="normal" autocapitalize="off" /></div><div class="formRow"><input name="j_password" placeholder="Password" type="password" class="normal" /></div><input name="from" type="hidden" value="/" /><div class="submit formRow"><input name="Submit" type="submit" value="Sign in" class="submit-button primary" /></div><script type="text/javascript">
